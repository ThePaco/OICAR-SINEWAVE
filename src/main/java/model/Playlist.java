...
public class Playlist {
    ...
    private Set<model.Playlistsong> playlistsongs = new LinkedHashSet<>();
    ...
    public Set<model.Playlistsong> getPlaylistsongs() {
        return playlistsongs;
    }

    public void setPlaylistsongs(Set<model.Playlistsong> playlistsongs) {
